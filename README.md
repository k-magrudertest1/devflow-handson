...
0-3. Settings > General > Collaborators にて、「Add people」をクリックし、共同作業者を招待します。(共同者のアカウントは各自ご確認ください。)
...
0-9. Issueタイトル・説明の入力とAssigneesの設定をしましょう。
...
0-10. 緑のボタンをクリックしてissueを作成してください。
